...
EndFunc   ;==>json_lex_string

Func json_lex_number($string)
	Local $json_number = ''
	Local $tmp[2]

	$json_number = StringRegExp($string, '^-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][+-]?[0-9]+)?', $STR_REGEXPARRAYFULLMATCH)
